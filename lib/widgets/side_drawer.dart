...
class _SideDrawerState extends State<SideDrawer> {
  ...
  @override
  void dispose() {
    ProfileUpdateNotifier.instance
        .removeListener(_onProfileUpdated);
    super.dispose();
  }
  ...
  String get _avatarUrl {
    ...
    if (img != null && img.isNotEmpty) {
      return "${ApiEndpoints.profileImage}$img";
    }
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    _item(Icons.live_tv_outlined, "Live Classes",
                        onTap: () => Navigator.pop(context)),
                    _item(Icons.workspace_premium_outlined,
                        "Certificates",
                        onTap: () {
                          Navigator.pop(context);
                          Navigator.push(
                    ...
                    _item(Icons.card_giftcard_outlined,
                        "Refer & Earn",
                        onTap: () => Navigator.pop(context)),
                    Divider(
